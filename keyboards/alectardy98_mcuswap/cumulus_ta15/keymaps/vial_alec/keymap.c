...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     ...
     KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSLS, KC_LBRC, KC_RBRC,    COPY,    PAST,        KC_7,    KC_8,    KC_9, KC_PCMM,  KC_DEL,   \
    ...
    KC_LCTL, _______, MO(_FN),                             KC_SPC,                                     KC_RALT, _______, KC_LEFT, KC_DOWN, KC_RGHT,                KC_P0, KC_PDOT),                    \
